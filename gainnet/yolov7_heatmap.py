...
def get_params():
    params = {
        'weight': 'E:/WX/YOLOv7/yolov7-coupling-main/runs/train/YOLOV7-PConv(骨干+颈部)-ATT(CA)-EMA/weights/best.pt',
        'device': 'cuda:0',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    model(r'E:/WX/YOLOv7/yolov7-coupling-main/dataset/images/test/0001070.jpg', 'result')