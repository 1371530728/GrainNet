...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 SPP, SPPF, SPPCSPC, GhostSPPCSPC,GhostSPPCSPC1,PSPPCSPC, MixConv2d, Focus, Stem, GhostStem, CrossConv,
                 ...
                 Yolov7x_E_ELAN, RCSOSA, Yolov7_Tiny_E_ELAN_Att, Yolov7_Tiny_E_ELAN_DySnake, DySnakeConv,
                 Yolov7_E_ELAN_PC,PConv,Yolov7_E_ELAN_PC_ATT,Conv_ATT,EMA,EfficientChannelAttention,CoordAtt,GAM_Attention
                 ,EffectiveSEModule,SimAM,SPPFCSPC,RFAConv,Yolov7_E_ELAN_RFAConv,Yolov7_E_ELAN_NECK_DySnake,SPPELAN,Yolov7_E_ELAN_NECK_pc]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='E:/WX/YOLOv7/yolov7-coupling-main/cfg/training/yolov7-xiaorong.yaml', help='model.yaml')
